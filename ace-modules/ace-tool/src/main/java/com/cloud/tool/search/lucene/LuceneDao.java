package com.cloud.tool.search.lucene;

import com.cloud.api.vo.search.IndexObject;
import com.cloud.tool.search.lucene.util.DocumentUtil;
import com.cloud.tool.search.lucene.util.IKAnalyzer5x;
import com.cloud.tool.search.lucene.util.QueryUtil;
